...
export type PostAuthenticationTrigger = Trigger<{
     ...
     */
    clientMetadata: Record<string, string> | undefined; source: "PostAuthentication_Authentication"; userAttributes: AttributeListType; username: string; userPoolId: string;
}, void>;
